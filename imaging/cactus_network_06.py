...
inPath = "/home/nagfa5/imaging/source/06/"
...
filename_prefix = "06_results"
filename = outPath+filename_prefix+".csv"
filename_m = outPath+filename_prefix+"_matrices.csv"

test_data = np.load(inPath+"test_data_with_PAA.npy")
train_data = np.load(inPath+"train_data_with_PAA.npy")
