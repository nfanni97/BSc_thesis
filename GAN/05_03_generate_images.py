...
region = sys.argv[1]
id = ['good','bad']
datafiles = ['02_time_'+i+'_'+region+'.npy' for i in id] # Data file name
print(datafiles)
size = [50]
...
for datafile in datafiles:
    fn = datafile
    print('read file: {}, GAF type: {}, rescale_type: {}'.format(datafile,  GAF_type, rescale_type))
    ...
    for s in size:
        ...
        np.save(path+'03'+datafile[2:],fullmatrix)
